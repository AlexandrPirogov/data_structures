...
2) Имеет ли граф отрицательные веса. Если граф не имеет отрицательный весов, то подойдет алгоритм `Дейкстры`. Если имеет то подойдет алгоритм `Беллмана-Форда`.
3) Имеет ли граф отрицательные циклы, то алгоритм `Беллмана-Форда` поможет обнаружить, имеет ли граф отрицательный цикл.

**Простота исполнения алгоритма сильно зависит от реализации графа**

|                    Тип графа                           |  Алгоритм                             |  Time complexety   |
--------------------------------------------------------:|:-------------------------------------:|:------------------:|
| Неориентированный и невзвешенный                       |    `BFS`                              | `O(\|E\|+\|V\|)`   | 
| НА взвешенный граф                                     | `DFS with Topological sort`           | `O(\|E\|+\|V\|)`   |
| Направленный взвешенный и не имеет отрицательных весов | `Дейкстра`                            | `O(\|E\|+log\|V\|)`| 
| Направленный взвешенный с отрицательными весами        | `Беллмана-Форда`                      |`O(\|E\|*\|V\|)`    |
| Направленный взвешенный с отрицательными циклами       | `Беллман-Форд поможет обнаружить цикл`|`O(\|E\|*\|V\|)`    |
